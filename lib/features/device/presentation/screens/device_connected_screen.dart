...
//             value: subscriptionPlan == 'Premium' ? 'Premium' : 'Basic',
//           ),
//         ],
//       ),
//     );
...
//         content: const Text(
//           'You\'re on Basic Case. To start the case please subscribe to Premium.',
//         ),
//         actions: [
//           TextButton(
...
//     final buttonText = isPremium ? 'Start Case' : 'Start Basic Case (Upgrade)';
...
//         // BUTTON for all users (internal testing text still separate)
//         ElevatedButton(
//           onPressed: isLoading
//               ? null
//               : () {
...
//             backgroundColor: isPremium ? const Color(0xFF10B981) : Colors.grey,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Single button – always green, always "Start Case"
        ElevatedButton(
          onPressed: isLoading
              ? null
              : () {
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color(0xFF10B981), // always green
            minimumSize: const Size(double.infinity, 48),
          ),
          child: AnimatedSwitcher(
            duration: const Duration(milliseconds: 200),
