...
class AppPrefs {
  ...
  static const _kSubscriptionPromptShown = 'subscription_prompt_shown';
  static const _kIsSubscribed = 'is_subscribed';
  static const _kSubscriptionPlan = 'subscription_plan'; // ✅ ADDED
  ...
  // ✅ NEW: Subscription plan (Basic / Premium)
  String? get subscriptionPlan => _sp.getString(_kSubscriptionPlan);
  Future<void> setSubscriptionPlan(String plan) =>
      _sp.setString(_kSubscriptionPlan, plan);
  ...
  Future<void> clearAll() async {
    ...
    await _sp.remove(_kSubscriptionPromptShown);
    await _sp.remove(_kIsSubscribed);
    await _sp.remove(_kSubscriptionPlan); // ✅ ADDED
