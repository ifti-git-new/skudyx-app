...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void initState() {
    ...
    address1 = TextEditingController(text: p.addressLine1);
    address2 = TextEditingController(text: p.addressLine2);

    city = TextEditingController(text: p.city);
    state = TextEditingController(text: p.state);
    zip = TextEditingController(text: p.zip);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        // Button that moves above keyboard
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _LabelField(label: 'Address Line 1', controller: address1),
                const SizedBox(height: 12),

                _LabelField(label: 'Address Line 2', controller: address2),
                const SizedBox(height: 12),
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 12),
                    Expanded(
                      child: _LabelField(label: 'Country', controller: country),
                    ),
                  ],
                ),
                ...
                const SizedBox(
                  height: 120,
                ), // extra space so last field not hidden by button
              ],
            ),
          ),
        ),
